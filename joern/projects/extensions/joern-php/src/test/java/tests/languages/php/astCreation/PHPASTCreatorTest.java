...
public class PHPASTCreatorTest extends PHPCSVBasedTest
{
	...
	public void testCatchCreation() throws IOException, InvalidCSVFile
	{
		...
		assertEquals( 3, node.getChildCount());
		assertEquals( ast.getNodeById((long)10), ((CatchStatement)node).getExceptionIdentifierList());
		assertEquals( ast.getNodeById((long)11), ((CatchStatement)node).getExceptionIdentifierList().getNameChild());
		assertEquals( "FooException", ((CatchStatement)node).getExceptionIdentifierList().getNameChild().getEscapedCodeStr());
		...
		assertEquals( 3, node2.getChildCount());
		assertEquals( ast.getNodeById((long)16), ((CatchStatement)node2).getExceptionIdentifierList());
		assertEquals( ast.getNodeById((long)17), ((CatchStatement)node2).getExceptionIdentifierList().getNameChild());
		assertEquals( "BarException", ((CatchStatement)node2).getExceptionIdentifierList().getNameChild().getEscapedCodeStr());
